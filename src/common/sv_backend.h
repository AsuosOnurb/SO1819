...
#define SV_INSTRUCTION_MOSTRAR_STOCK_E_PRECO ((char) 1)
/** @brief Define que a instrução de atualizar o stock e mostrar o novo stock tem o ID 2. */
#define SV_INSTRUCTION_ATUALIZAR_STOCK_E_MOSTRAR_NOVO_STOCK ((char) 2)
/** @brief Define que a instrução de correr o agregador tem o ID 3. */
#define SV_INSTRUCTION_EXECUTAR_AG ((char) 3)
 ...
 *
 * @param instruction O ID da instrução a enviar
